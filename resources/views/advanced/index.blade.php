    ...
    <table class="table">
        ...
        @foreach($users as $user)
            <tr>
                ...
                <td>{{$user->type}}</td>
                <td>
                    <a class="btn btn-info" href="{{url('advanced/'.$user->id)}}">Show</a></button>
                </td>
                <td>
                    <a class="btn btn-warning" href="{{url('advanced/'.$user->id.'/edit')}}">Edit</a>
                </td>
                <td>
                    
                        <!-- Button trigger modal -->
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalDelete"
                    data-name="{{$user->name}}" data-url="{{'advanced/'.$user->id}}">
                      Delete
                    </button>
                    ...
                    <!--<form action="{{url('advanced/'.$user->id )}}" method="POST">-->
                    <!--    @csrf-->
                    <!--    @method('delete')-->
